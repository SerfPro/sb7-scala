...
class SingleTri extends ApplicationListener {
  import SingleTriShaders._

  private val clearC = bufferF(Array(0.0f, 0.2f, 0.0f, 1.0f))
  private val vaos   = bufferI(Array(0))
...
object SingleTri extends App {
  val app = new DefaultLwjglApp(new SingleTri()) {
