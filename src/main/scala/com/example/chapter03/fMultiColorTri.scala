...
class fMultiColorTri extends ApplicationListener {
  import fMultiColorTriShaders._
...
object fMultiColorTri extends App {
  val app = new DefaultLwjglApp(new fMultiColorTri()) {
