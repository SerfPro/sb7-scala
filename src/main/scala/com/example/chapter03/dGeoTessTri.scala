...
import org.lwjgl.opengl._, GL11._, GL20._, GL30._, GL32._, GL40._
import GL45.glCreateVertexArrays

import com.example.common._

class dGeoTessTri extends ApplicationListener {
  import dGeoTessTriShaders._
...
object dGeoTessTri extends App {
  val app = new DefaultLwjglApp(new dGeoTessTri()) {
